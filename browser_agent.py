...
def _build_enriched_prompt(task_type: str, email: str, admin_url: str) -> str:
    ...
    if task_type == "disable_account":
        return (
            ...
            f"1. Open the admin panel at {admin_url}.\n"
            "2. Type the target email into the 'Search user' input.\n"
            "3. In the table row for that user, check the buttons. If the button says 'Enable', stop and return 'USER_ALREADY_DISABLED'.\n"
    ...
    if task_type == "enable_account":
        return (
            ...
            f"1. Open the admin panel at {admin_url}.\n"
            "2. Type the target email into the 'Search user' input.\n"
            "3. In the table row for that user, check the buttons. If the button says 'Disable', stop and return 'USER_ALREADY_ENABLED'.\n"
